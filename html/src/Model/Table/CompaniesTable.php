 ...
 * Companies Model
 *
 * @property \App\Model\Table\BusinessCategoriesTable&\Cake\ORM\Association\BelongsTo $BusinessCategories
...
class CompaniesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ...
            ->requirePresence('business_category_id', 'create')
            ->notEmptyString('business_category_id');
        ...
        $validator
            ->scalar('company_kana')
            ->maxLength('company_kana', 200)
            ->requirePresence('company_kana', 'create')
            ->notEmptyString('company_kana');
    ...
    {
        $rules->add($rules->existsIn('business_category_id', 'BusinessCategories'), ['errorField' => 'business_category_id']);
